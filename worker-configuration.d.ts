/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 247cc267cd8105320f28a44d626d6482)
// Runtime types generated with workerd@1.20260611.1 2026-06-14 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	LOADER: WorkerLoader;
	AI: Ai;
	SUPERVISOR: DurableObjectNamespace<import("./src/index").AppSupervisor>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AppSupervisor";
	}
